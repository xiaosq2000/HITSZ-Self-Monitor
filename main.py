...
print("输入学号")
driver.find_element(by=By.XPATH, value=
    '/html/body/div/div[2]/div/form/div/div[2]/ul/li[1]/input[1]').send_keys(config["profiles"]["id"])
print("输入密码")
driver.find_element(by=By.XPATH, value=
    '/html/body/div/div[2]/div/form/div/div[2]/ul/li[1]/input[2]').send_keys(config["profiles"]["password"])
driver.find_element(by=By.XPATH, value=
...
print("今日是否已经上报")
flag = driver.find_element(by=By.XPATH, value=
...
if flag == '已提交':
    ...
    picker_indicator = driver.find_element(by=By.XPATH, value=
